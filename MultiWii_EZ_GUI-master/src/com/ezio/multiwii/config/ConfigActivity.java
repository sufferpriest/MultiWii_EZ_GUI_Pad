...
//		Log.d(BT_old.TAG, "onActivityResult " + resultCode);
	...
	public void DownloadTTSEspeak(View v) {
		app.alertInstallEyesFreeTTSData(this);
	}
	...
	protected void onResume() {
		...
		CheckBoxUseOfflineMap.setChecked(app.mMapEngine==App.MAP_GOOGLE?true:false);
	...
	public void SaveSettingsOnClick(View v) {
		...
		app.mMapEngine = CheckBoxUseOfflineMap.isChecked()?App.MAP_GOOGLE:App.MAP_OSM;
