...
//
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		s1.topText = getString(R.string.MaxThrottle);
		s1.rightText = getString(R.string.Yaw);
		
		s1.y_init = 1000;
		
		s2 = (StickView) findViewById(R.id.stickView2);
		s2.topText = getString(R.string.Pitch);
		s2.rightText = getString(R.string.Roll);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == MENU_AUX) {
			...
			findViewById(R.id.seektable_aux).setVisibility(View.VISIBLE);
			...
			findViewById(R.id.seektable_tuning).setVisibility(View.VISIBLE);
			findViewById(R.id.seektable_aux).setVisibility(View.GONE);
			...
			CH8[0] = 2000;// roll
			app.mw.SendRequestMSP_SET_RAW_RC(CH8);
			Toast.makeText(getApplicationContext(), "Arming...", Toast.LENGTH_SHORT).show();
			...
			CH8[0] = 1000;// roll
			app.mw.SendRequestMSP_SET_RAW_RC(CH8);
			Toast.makeText(getApplicationContext(), "Disarming...", Toast.LENGTH_SHORT).show();
			mHandler.postDelayed(new Runnable() {
				@Override
				public void run() {
					mHandler.removeCallbacks(null);	
