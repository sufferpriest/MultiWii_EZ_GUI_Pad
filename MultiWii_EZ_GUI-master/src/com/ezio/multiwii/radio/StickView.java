...
public class StickView extends View {
	...
	public float x, y;
	public float x_init = 1500, y_init = 1500;
	public String topText, rightText;
	int hh, ww;
	...
	protected void onDraw(Canvas canvas) {
		...
		if (topText != null) canvas.drawText(topText, ww / 2 + 10, 50, paint3);
		if (rightText != null) canvas.drawText(rightText, ww - 50, hh / 2 - 20, paint3);
