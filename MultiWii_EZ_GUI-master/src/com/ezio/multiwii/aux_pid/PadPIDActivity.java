...
public class PadPIDActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		P1 = (EditText) mContext.findViewById(R.id.P1);
		P2 = (EditText) mContext.findViewById(R.id.P2);
		P3 = (EditText) mContext.findViewById(R.id.P3);
		P4 = (EditText) mContext.findViewById(R.id.P4);
		P5 = (EditText) mContext.findViewById(R.id.P5);
		P6 = (EditText) mContext.findViewById(R.id.P6);
		P7 = (EditText) mContext.findViewById(R.id.P7);
		P8 = (EditText) mContext.findViewById(R.id.P8);
		P9 = (EditText) mContext.findViewById(R.id.P9);

		D1 = (EditText) mContext.findViewById(R.id.D1);
		D2 = (EditText) mContext.findViewById(R.id.D2);
		D3 = (EditText) mContext.findViewById(R.id.D3);
		D4 = (EditText) mContext.findViewById(R.id.D4);
		D5 = (EditText) mContext.findViewById(R.id.D5);
		D6 = (EditText) mContext.findViewById(R.id.D6);
		D7 = (EditText) mContext.findViewById(R.id.D7);
		D8 = (EditText) mContext.findViewById(R.id.D8);
		D9 = (EditText) mContext.findViewById(R.id.D9);

		I1 = (EditText) mContext.findViewById(R.id.I1);
		I2 = (EditText) mContext.findViewById(R.id.I2);
		I3 = (EditText) mContext.findViewById(R.id.I3);
		I4 = (EditText) mContext.findViewById(R.id.I4);
		I5 = (EditText) mContext.findViewById(R.id.I5);
		I6 = (EditText) mContext.findViewById(R.id.I6);
		I7 = (EditText) mContext.findViewById(R.id.I7);
		I8 = (EditText) mContext.findViewById(R.id.I8);
		I9 = (EditText) mContext.findViewById(R.id.I9);

		RollPitchRate = (EditText) mContext.findViewById(R.id.editTextRatePitchRoll1);
		RollPitchRate2 = (EditText) mContext.findViewById(R.id.editTextRatePitchRoll2);
		YawRate = (EditText) mContext.findViewById(R.id.editTextRateYaw);

		ThrottleMid = (EditText) mContext.findViewById(R.id.editTextMIDThrottle);
		ThrottleExpo = (EditText) mContext.findViewById(R.id.editTextEXPOThrottle);

		RcRate = (EditText) mContext.findViewById(R.id.editTextRate2PitchRoll);
		RcExpo = (EditText) mContext.findViewById(R.id.editTextEXPOPitchRoll);

		ThrottleRate = (EditText) mContext.findViewById(R.id.editTextTPA);
	...
	private void loadProfileFiles() {
		...
		if (success) {
			...
			spinnerProfile = (Spinner) mContext.findViewById(R.id.spinnerProfile);
			ArrayAdapter aa = new ArrayAdapter(mContext, android.R.layout.simple_spinner_item, l);
	...
	public void ResetOnClick(View v) {
		...
		builder.setMessage(mContext.getString(R.string.ResetALLnotonlyPIDparamstodefault)).setCancelable(false).setPositiveButton(mContext.getString(R.string.Yes), new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int id) {
				...
				ReadOnClick(null);
				Toast.makeText(mContext.getApplicationContext(), mContext.getString(R.string.ValuesaresettodefaultPressreadbuttonnow), Toast.LENGTH_LONG).show();
	...
	void ShareIt() {
		...
		try {
			...
			Toast.makeText(mContext.getBaseContext(), e.getMessage(), Toast.LENGTH_SHORT).show();
		}
	...
	public void SaveProfileOnClick(View v) {
		...
		alert.setTitle(mContext.getString(R.string.EnterFileName));
		...
		alert.setPositiveButton(mContext.getString(R.string.Save), new DialogInterface.OnClickListener() {
	...
	private void SaveToXml(String fileName) throws InvalidPropertiesFormatException, IOException {
		...
		Toast.makeText(mContext.getApplicationContext(), mContext.getString(R.string.Settingssaved), Toast.LENGTH_SHORT).show();
