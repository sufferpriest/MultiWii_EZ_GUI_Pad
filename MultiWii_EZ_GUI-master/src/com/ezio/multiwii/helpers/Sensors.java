...
public class Sensors implements SensorEventListener, LocationListener {
	...
	private String provider, provider_network;
	...
	public com.google.android.maps.GeoPoint getGoogleMapGeoPoint() {
		return new com.google.android.maps.GeoPoint(geopointOfflineMapCurrentPosition.getLatitudeE6(), geopointOfflineMapCurrentPosition.getLongitudeE6());
	}
	...
	public Sensors(Context context) {
		...
		provider_network = locationManager.NETWORK_PROVIDER;//PASSIVE_PROVIDER
		location = locationManager.getLastKnownLocation(provider);
		if (location == null) {
			location = locationManager.getLastKnownLocation(provider_network);
		}
	...
	public void onLocationChanged(Location location) {
		...
		if (location.getProvider() == LocationManager.NETWORK_PROVIDER && PhoneNumSat > 1) {
